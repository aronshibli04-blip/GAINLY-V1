...
**AI Coach Removal & Nutrition Page (August 18, 2025)**: Removed AI Coach chat functionality due to poor response quality and replaced it with a dedicated Nutrition Guide page. The new page focuses on hardgainer-specific food recommendations, high-calorie foods database, meal timing strategies, and practical nutrition tips without chat interface. This provides more reliable and actionable nutrition guidance for weight gain.
