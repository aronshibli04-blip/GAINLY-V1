        ...
        meals: [
          {
            ...
            calories: Math.round(currentTdeeAnalysis.targetCalories * 0.25),
            ingredients: [
              { id: "1", name: "Oatmeal", amount: 80, unit: "g", calories: 300 },
              { id: "2", name: "Banana", amount: 1, unit: "medium", calories: 105 },
              { id: "3", name: "Protein powder", amount: 30, unit: "g", calories: 120 },
              { id: "4", name: "Almonds", amount: 20, unit: "g", calories: 115 }
            ],
            instructions: "Mix oatmeal with protein powder, add sliced banana and almonds"
          },
          {
            id: "2",
            name: "Power Lunch",
            type: "lunch" as const,
            calories: Math.round(currentTdeeAnalysis.targetCalories * 0.35),
            ingredients: [
              { id: "5", name: "Chicken breast", amount: 200, unit: "g", calories: 330 },
              { id: "6", name: "Brown rice", amount: 100, unit: "g", calories: 350 },
              { id: "7", name: "Broccoli", amount: 150, unit: "g", calories: 50 },
              { id: "8", name: "Olive oil", amount: 15, unit: "ml", calories: 120 }
            ],
          ...
          },
          {
            ...
            calories: Math.round(currentTdeeAnalysis.targetCalories * 0.3),
            ingredients: [
              { id: "9", name: "Salmon", amount: 180, unit: "g", calories: 360 },
              { id: "10", name: "Sweet potato", amount: 200, unit: "g", calories: 180 },
              { id: "11", name: "Spinach", amount: 100, unit: "g", calories: 25 },
              { id: "12", name: "Avocado", amount: 80, unit: "g", calories: 130 }
            ],
            instructions: "Bake salmon with roasted sweet potato and sautéed spinach"
          }
        ],
            ...
            <CardContent className="space-y-4">
              ...
              {currentTdeeAnalysis && (
                <div className="text-center p-3 rounded-lg bg-muted/20">
                  <p className="text-xs text-muted-foreground">Target Daily Calories</p>
